...
import { contextRoute } from "@server/feature/context/route";
import { productsRoute } from "@server/feature/products/route";
import { pagesRoute } from "@server/feature/pages/route";
import { cartRoute } from "@server/feature/cart/route";
...
export default async function (server: FastifyInstance) {
	...
	const privateRoutes = async (privateServer: FastifyInstance) => {
		...
		privateServer.register(contextRoute);
		privateServer.register(cartRoute);
	};
